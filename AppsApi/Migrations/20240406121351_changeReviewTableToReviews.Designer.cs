...
namespace AppsApi.Migrations
{
    ...
    [Migration("20240406121351_changeReviewTableToReviews")]
    partial class changeReviewTableToReviews
    {
            ...
            modelBuilder.Entity("AppsApi.Data.Entities.Developer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(4965),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(4968),
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(4969),
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(4970),
                        ...
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(4971),
                        ...
                        {
                            Id = 6,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(5064),
                        ...
                        {
                            Id = 7,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(5065),
                        ...
                        {
                            Id = 8,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(5066),
                        ...
                        {
                            Id = 9,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(5067),
                        ...
                        {
                            Id = 10,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(5071),
            ...
            modelBuilder.Entity("AppsApi.Data.Entities.Genre", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(4710),
                            Name = "Action"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(4720),
                            Name = "Adventure"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(4722),
                            Name = "Role-Playing Game (RPG)"
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(4723),
                            Name = "Strategy"
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(4724),
                            Name = "Simulation"
                        },
                        new
                        {
                            Id = 6,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(4726),
                            Name = "Puzzle"
                        },
                        new
                        {
                            Id = 7,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(4727),
                            Name = "Platformer"
                        },
                        new
                        {
                            Id = 8,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(4728),
                            Name = "Racing"
                        },
                        new
                        {
                        ...
                        {
                            Id = 10,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(4730),
                            Name = "Sports"
                        },
                        new
                        {
                            Id = 11,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(4731),
                            Name = "Sandbox"
                        },
                        new
                        {
                            Id = 12,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(4732),
                            Name = "Stealth"
                        },
                        new
                        {
                            Id = 13,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(4733),
                            Name = "Survival"
                        },
                        new
                        {
                            Id = 14,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(4734),
                            Name = "Horror"
                        },
                        new
                        {
                            Id = 15,
                            CreatedAt = new DateTime(2024, 4, 6, 15, 13, 51, 688, DateTimeKind.Local).AddTicks(4735),
                            Name = "Visual Novel"
                        });
                });
